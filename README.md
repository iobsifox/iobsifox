...
**WooCommerce → Minecraft store bridge, fully Persian/RTL** — custom cart & checkout, 5-minute link codes with dashboard/email verification, automatic item & rank delivery, in-game claim GUI where every purchase is a paper named by its purchase code, rank hierarchy with hourly sync from the server, and a standalone support-ticket system. Ships as a WordPress plugin plus a Spigot/Paper plugin.

<img src="https://img.shields.io/github/v/release/iobsifox/BazzarMc?include_prereleases&style=flat-square&color=16A34A"/> <img src="https://img.shields.io/badge/WordPress_6.0%2B-21759B?style=flat-square&logo=wordpress&logoColor=white"/> <img src="https://img.shields.io/badge/Spigot__Paper_1.16--1.21-ED8B00?style=flat-square&logo=openjdk&logoColor=white"/> <img src="https://img.shields.io/badge/WooCommerce-96588A?style=flat-square&logo=woocommerce&logoColor=white"/>
